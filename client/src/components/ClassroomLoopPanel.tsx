...
const provenanceFor = (activity: ClassroomActivity): Provenance => ({ sourceObjectId: activity.sourceObjectId, sourceRange: { start: 0, end: activity.mathStepSession?.problem.equation.length ?? 10 }, sourceVersion: activity.sourceVersion, derivationType: "classroom-workflow", teacherApproved: false });
