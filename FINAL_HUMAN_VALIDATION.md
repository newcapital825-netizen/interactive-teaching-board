...
النسخة الحالية لديها دليل آلي على 26 ملف اختبار Vitest و130 اختبارًا ناجحًا، و36 اختبار Playwright ناجحًا (18 سطح مكتب و18 محمول)، ونجاح TypeScript check وproduction build و`git diff --check`. كما تم التحقق بصريًا من RTL والتخطيط على 1280×720 و390×844. هذه الأدلة لا تثبت الجلسات البشرية، ولا اللمس الحقيقي أو القلم أو قارئ الشاشة أو أداء جهاز واقعي.
